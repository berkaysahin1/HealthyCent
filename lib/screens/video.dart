...
class _VideoState extends State<Video> {
  ...
  Future<List<Videos>> videoList()async{
    ...
    return List.generate(maps.length,(i){
      var satir=maps[i];
      return  Videos(satir["video_Id"], satir["video_Foto"], satir["video_Adi"], satir["video_EgitmenAdi"], satir["video_Icerik"]);
    });
  }
  late int sppuan;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      child: Text(
        "Videolar",textAlign: TextAlign.center,
        style: TextStyle(
          fontSize: 25.0,
              ...
              itemBuilder: (context,index){
                ...
                return GestureDetector(
                  onTap: (){
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (context) => videoDetails(video: video,)));
                  },
                  child: Card(
                    color: Colors.red,
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(video.video_Adi,style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.white),),
                        Text(video.video_EgitmenAdi,style: TextStyle(fontSize: 12,color: Colors.white),),
                      ],
                    ),
                  ),
                );
